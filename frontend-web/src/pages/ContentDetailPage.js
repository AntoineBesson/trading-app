...
const styles = {
  ...
  body: { lineHeight: '1.6', whiteSpace: 'pre-wrap', color: '#444' }, // pre-wrap to respect newlines in text
  videoContainer: {
    margin: '20px 0',
    position: 'relative',
    ...
    <div style={styles.page}>
      ...
      {content.body && (
        <div style={styles.body}>
          {/* Using <pre> might be better if body is pre-formatted text, or parse markdown */}
          <p>{content.body}</p>
        </div>
      )}
      <hr />
